...
class Sector(models.Model):
    ...
    boundary = geomodels.MultiPolygonField()  # Assuming the boundary is a polygon
    centroid = geomodels.PointField()  # Assuming the centroid is a point
...
class Area(models.Model):
    ...
    sector = models.ForeignKey(Sector, on_delete=models.CASCADE)  # Assuming an area belongs to a sector
    boundary = geomodels.MultiPolygonField()  # Assuming the boundary is a polygon
    centroid = geomodels.PointField()  # Assuming the centroid is a point
    name = models.CharField(max_length=100)
    description = models.TextField()
...
class SubArea(models.Model):
    ...
    area = models.ForeignKey(Area, on_delete=models.CASCADE)  # Assuming a subarea belongs to an area
    name = models.CharField(max_length=100)
...
class Routes(models.Model):
    ...
    subarea = models.ForeignKey(SubArea, on_delete=models.CASCADE)  # Assuming a route belongs to a subarea
    name = models.CharField(max_length=100)
    ...
    coordinates = geomodels.PointField()  # Assuming the coordinates are a point (e.g., start of the route)
    description = models.TextField()
...
class Parking(models.Model):   
    ...
    name = models.CharField(max_length=100)
    description = models.TextField()
    location = geomodels.PointField()  # Assuming the parking location is a point
...
class StartPoints(models.Model):
    ...
    name = models.CharField(max_length=100)
    location = geomodels.PointField()  # Assuming the start point location is a point
...
class Camping(models.Model):
    ...
    name = models.CharField(max_length=100)
    description = models.TextField()
    location = geomodels.PointField()  # Assuming the camping location is a point
...
class Restroom(models.Model):
    ...
    name = models.CharField(max_length=100)
    description = models.TextField()
    location = geomodels.PointField()  # Assuming the restroom location is a point
